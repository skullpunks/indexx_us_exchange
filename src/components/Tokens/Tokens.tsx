...
import hash from '../../assets/tokenimages/Hash.png'
import main from '../../assets/tokenimages/main.png'
        ...
        <>
            <div className="scan-container how-it-works flex-direction-column text-center ">
                ...
                <div className="row justify-content-md-center" style={{ marginTop: 20 }}>
                    <Image src={main} width={400} preview={false}></Image>
                    <h1 style={{ fontSize: 30, opacity: '70%' }}>Token Information</h1>
                ...
                <div className="row justify-content-md-center" style={{ marginTop: 130 }}>
                    <div className="col-3">
                        <Link to="/indexx-exchange/token-details/inex">
                            ...
                            <Text italic strong className='inextext'>IndexxEXCHANGE<span style={{ fontSize: 15, marginTop: 12 }}>&#8482;</span> INEX</Text> <br />
                    ...
                    <div className="col-3">
                        ...
                        <a href='https://sorekt.wtf'>
                            ...
                            <Text  >So Rekt's meme token</Text><br />
                        </a>
                        <a href={"https://docdro.id/Ta5535w"}> <Text strong  style={{ fontSize: 20 }} >Whitepaper</Text></a><br />
                        <a href={'https://docdro.id/cXHu30O'}> <Text strong  style={{ fontSize: 20 }}>Tokenomics</Text></a><br /><br />
                ...
                <div className="row justify-content-md-center" style={{ marginTop: 130 }}>
                    <div className="col-3">
                        <Link to="/indexx-exchange/token-details/inex">
                            <Image preview={false} src={hash} width={99} className="scaleup"></Image><br />
                            <Text italic strong className='hashtext'>Indexx<span style={{ fontSize: 15, marginTop: 12 }}>&#8482;</span> Hash</Text> <br />
                            <Text className='hashlinktext' >Cloud Mining Token</Text><br />
                        </Link>
                         <Text strong className='hashlinktext' style={{ fontSize: 20 }} >Whitepaper</Text><br />
                        <Text strong className='hashlinktext' style={{ fontSize: 20 }}>Tokenomics</Text><br /><br />
                        <a href={baseDEXURL}>   <Button type="primary" shape="round" className='seventhButton'> Buy Tokens</Button></a>
                    </div>
